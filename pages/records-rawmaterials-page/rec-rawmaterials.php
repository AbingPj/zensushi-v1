        ...
        <div class="container myMinimumContent">
            <div class="row">
                ...
                <div class="col-sm-12 col-md-12 col-lg-12  mx-auto  myOpacity5">
                    <h2 style="margin: 10px 20px 15px 20px">Raw Materials Inventory Records </h2>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12 mx-auto myOpacity2">
                    ...
                    <div class="tab-content myOpacity6" id="nav-tabContent">
                        ...
                        <!--stock-in--> 
                        <div style="margin: 0px 20px 0px 20px" class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        ...
                        <!---->
                        <!-- stock out-->
                        <div style="margin: 0px 20px 0px 20px" class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
